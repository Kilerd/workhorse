...
- 4px base spacing system with compact padding throughout for high content density
...
### Spacing System
- Base unit: 4px
- Scale: 1px, 2px, 4px, 6px, 8px, 10px, 12px, 16px, 20px, 24px, 32px, 40px, 48px
- Prefer compact padding throughout the UI to maximize content density
- Page-level content padding: 12px (p-3)
- Section/card internal padding: 12-16px (p-3 to p-4)
- Page headers: px-16px py-10px (px-4 py-2.5)
- Tab bars: px-16px (px-4)
- Column headers: px-12px py-8px (px-3 py-2)
- List item gaps: 10px (gap-2.5)
- Card gaps in grids: 12px (gap-3)
- CTA buttons: 8px 16px for standard, 12px 16px for large
...
- **Compact density**: Tight padding throughout (12-16px for sections, 8-12px for elements) to maximize content density. The app prioritizes information visibility over whitespace.
...
- Use compact but comfortable padding on buttons and containers -- density over spaciousness
...
- Don't use excessive padding that wastes screen space -- prefer compact, information-dense layouts
...
### Touch Targets
- Large CTA buttons: 12px 16px padding
- Standard buttons: 8px 12px padding
- Small buttons: 6px 12px padding
- Navigation links: 16px weight 500 with adequate spacing
- Tab items: 10px 12px padding (py-2.5 px-3)
...
- Section spacing: 48-64px reduces to 32-40px on mobile
...
5. Keep padding compact (12px 16px for large buttons) -- density over spaciousness
